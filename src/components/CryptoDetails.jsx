...
{ title: 'All-time-high(daily avg.)', value: data?.data?.coin?.allTimeHigh.price, icon: <TrophyOutlined /> },
  ...
  const genericStats = [
    ...
    { title: 'Total Supply', value: data?.data?.coin?.totalSupply , icon: <ExclamationCircleOutlined /> },
    { title: 'Circulating Supply', value: data?.data?.coin?.circulatingSupply, icon: <ExclamationCircleOutlined /> },
  ];
  ...
  return (
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        ...
        <p>{data?.data?.coin.name}live price is in US dollars.
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overview showing the statistics of {data?.data?.coin.name}</p>
          </Col>
